...
let
  ...
  colours = import ./themes/flat-white.nix;
in {
  services = {
    polybar = {
      enable = true;
      ...
      config = {
        ...
        "module/layout" = {
          ...
          format = "<label>";
          format-background = "#f7e0c3";
          format-foreground = colours.basefg;
          format-padding = 1;
        ...
        "module/volume" = {
          ...
          format-volume-background = "#dde4f2";
